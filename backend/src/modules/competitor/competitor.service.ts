  ...
  async fetchCompetitorFacebookReport(id: string) {
    ...
    return this.prisma.competitorFacebookReport.upsert({
      ...
      update: {
        ...
        adsImageCount: adsData.adsImageCount,
        adsCarouselCount: adsData.adsCarouselCount,
        adsDcoCount: adsData.adsDcoCount,
        adsCtaWebsite: adsData.adsCtaWebsite,
        adsCtaDirectMessage: adsData.adsCtaDirectMessage,
        adsCtaInstagramPage: adsData.adsCtaInstagramPage,
