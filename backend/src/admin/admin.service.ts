...
export class AdminService {
  ...
  async signIn(body: any): Promise<ApiResponse<AuthResponse<TAdmin>>> {
  ...
  private async _generateToken(admin: TAdmin): Promise<ApiResponse<AuthResponse<TAdmin>>> {
