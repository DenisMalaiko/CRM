...
describe('AdsFormatChart', () => {
  it('renders the title', () => {
    render(<AdsFormatChart adsVideoCount={5} adsImageCount={3} adsCarouselCount={2} adsDcoCount={0} />)

    expect(screen.getByText('Ads Formats')).toBeInTheDocument()
  })

  it('shows "No data yet" when all counts are 0', () => {
    render(<AdsFormatChart adsVideoCount={0} adsImageCount={0} adsCarouselCount={0} adsDcoCount={0} />)
  ...
  it('shows total for partial counts', () => {
    render(<AdsFormatChart adsVideoCount={0} adsImageCount={10} adsCarouselCount={5} adsDcoCount={0} />)

    expect(screen.getByText('15')).toBeInTheDocument()
  })

  it('does not show "No data yet" when total is greater than 0', () => {
    render(<AdsFormatChart adsVideoCount={1} adsImageCount={0} adsCarouselCount={0} adsDcoCount={0} />)
